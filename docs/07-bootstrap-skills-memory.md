...
| `internal/store/file/memory.go` | FileMemoryStore -- wraps memory.Manager, KG stubs for standalone |
...
| `internal/tools/memory.go` | memory_search + memory_get tools (standalone + managed modes) |
